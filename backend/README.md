...
## Project Structure
    ...
    ├── testapiautocatalog_116429  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_116429`
...
2. Clone this repo and `cd testapiautocatalog_116429`
